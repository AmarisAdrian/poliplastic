<div class="container">
    ...
    <div class="text-center">
        <a class="text-center" href="asset/upload/plantilla_linea.xlsx" download="PlantillaSubirLinea">
            <i class="fas fa-file-excel"></i> <b>Descargar plantilla</b>
        </a>
    </div>
    <br>
    <hr><br>
    <form name="frm_subir_linea" id="frm_subir_linea" action="./?view=add_subir_linea" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="text-center">
            <div class="col-md-12">
                <input type="submit" id="btn_subir_linea" class=" btn_subir_linea btn bg-nav text-light btn-fill btn-wd" value=" Subir archivo"/>
            </div>
        </div>
    </form>
</div>