<div class="container">
    ...
    <div class="text-center">
        <a class="text-center" href="asset/upload/plantilla_linea_inventario.xlsx" download="PlantillaSubirInventario">
            <i class="fas fa-file-excel"></i> <b>Descargar plantilla</b>
        </a>
    </div>
    <br>
    <hr><br>
    <form name="frm_subir_inventario" id="frm_subir_inventario" action="./?view=add_subir_inventario" method="POST" role="form" enctype="multipart/form-data">
