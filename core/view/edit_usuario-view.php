<?php if(isset($_GET["id"]) && !is_null($_GET["id"]) && is_numeric($_GET["id"])){
  $val =UsuarioModel::GetByDocumento($_SESSION['noDocumento']);
  $usuario = UsuarioModel::GetById($_GET["id"]);
  if($val->idTipoUsuario==1){
   ?>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                ...
                ?>
                    <form class="form-horizontal" id="addvotante" action="./?view=update_usuario" method="POST" role="form">
                        <br />
                        <div class="row">
